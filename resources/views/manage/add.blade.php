    ...
    <div class="[ col-xs-12 col-sm-offset-2 col-sm-8 ]">
      <div class="[ panel panel-default ] panel-marawthon admin">
        ...
        <div class="panel-footer">
          <hr>
          <p class="meta" style="margin: 0;">Contact tech@radio.warwick.ac.uk for help.</p>
        </div>
      </div>
    </div>
  </div>
